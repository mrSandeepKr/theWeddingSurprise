...
export default function EventsSection() {
  ...
  const getColorClasses = (color: string) => {
    ...
    return colorMap[color as keyof typeof colorMap] || "border-wedding-sindoor-200 bg-wedding-sindoor-50/50";
  };
  ...
  return (
    <section id="events" className="py-20 px-6 bg-gradient-to-b from-white to-wedding-gold-50/30">
      <motion.div
        ref={ref}
      ...
      >
        ...
        <div className="space-y-8">
          {events.map((event, index) => (
            <Card key={index} className={`${getColorClasses(event.color)} shadow-lg hover:shadow-xl transition-all duration-300 border-2`}>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div className="p-4 rounded-lg bg-wedding-haldi-100/50 border border-wedding-haldi-200">
                  <h4 className="font-semibold text-wedding-haldi-800 mb-2 font-playfair">Haldi & Mehendi</h4>
                  <p className="text-wedding-haldi-700 font-crimson">Bright colors, comfortable traditional wear</p>
                </div>
                <div className="p-4 rounded-lg bg-wedding-magenta-100/50 border border-wedding-magenta-200">
                  <h4 className="font-semibold text-wedding-magenta-800 mb-2 font-playfair">Sangeet</h4>
                  <p className="text-wedding-magenta-700 font-crimson">Festive attire, ready to dance!</p>
                </div>
                <div className="p-4 rounded-lg bg-wedding-royal-100/50 border border-wedding-royal-200">
                  <h4 className="font-semibold text-wedding-royal-800 mb-2 font-playfair">Wedding & Reception</h4>
                  <p className="text-wedding-royal-700 font-crimson">Formal traditional or contemporary wear</p>
                </div>
              </div>
            </CardContent>
          </Card>
