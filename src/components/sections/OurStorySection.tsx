  ...
  const milestones = [
    {
      ...
      title: "First Meeting",
      date: "June 2023",
      description: "Our paths crossed on a trip to Rameshwaram, and there was an instant connection that we both felt."
    },
    {
      icon: <Sparkles className="h-8 w-8 text-rose-600" />,
      title: "First Date",
      date: "July 2023",
      description: "A night of watching Harry potter series and cooking Dosa together XD. We knew we had found something special."
    },
    {
      icon: <Calendar className="h-8 w-8 text-rose-600" />,
      title: "Telling our parents",
      date: "Aug 2024",
      description: "Taking the next step in our relationship, we decided to share the happy news with our parents."
    },
    {
      icon: <Gem className="h-8 w-8 text-rose-600" />,
      title: "The Proposal",
      date: "TBD",
      description: "She will kill the person building the website if he doesn't propose. He has all the intentions to just not getting a chance :)"
    }
  ];
    ...
    <section id="story" className="py-20 px-6 bg-gradient-to-br from-rose-50 to-pink-50">
      ...
      >
        <div className="text-center mb-16">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.5 }} transition={{ duration: 0.8, delay: 0.5 }}>
