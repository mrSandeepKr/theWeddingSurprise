          ...
          <Card className="border-green-200 shadow-lg bg-green-50">
            <CardContent className="p-12">
              ...
              <p className="text-lg text-green-700 mb-6">
                Your RSVP has been received successfully. We're so excited to
                celebrate with you!
              </p>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-rose-700 max-w-2xl mx-auto">
            Please confirm your attendance by December 15, 2024. We can't wait
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                disabled={
                  !formData.name || !formData.email || !formData.attendance
                }
              >
                Submit RSVP
              </Button>
